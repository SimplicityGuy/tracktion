...
- [ ] Create `services/analysis_service/src/bpm_detector.py`
- [ ] Implement `BPMDetector` class with Essentia RhythmExtractor2013
- [ ] Add fallback to Essentia PercivalBpmEstimator for low confidence
- [ ] Include error handling for audio loading failures
- [ ] Add type hints and comprehensive docstrings
- [ ] Create unit test `tests/unit/analysis_service/test_bpm_detector.py`
- [ ] Test with reference tracks of known BPMs (±2 BPM accuracy)
- [ ] Run pre-commit hooks and fix any issues

### 2. Implement Temporal BPM Analysis
- [ ] Create `services/analysis_service/src/temporal_analyzer.py`
- [ ] Implement windowed BPM calculation (default 10-second windows)
- [ ] Calculate start BPM (first 30 seconds) and end BPM (last 30 seconds)
- [ ] Compute average BPM and tempo stability score
- [ ] Handle variable tempo detection and confidence scoring
- [ ] Create unit test `tests/unit/analysis_service/test_temporal_analyzer.py`
- [ ] Test with DJ mixes and classical music (variable tempo)
- [ ] Verify memory efficiency for long tracks
