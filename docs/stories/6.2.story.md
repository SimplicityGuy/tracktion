...
- [ ] Consider extracting time parsing logic to a utility module
- [ ] Add integration tests for CUE file generation flow
- [ ] Implement proper async handling for CUE generation (currently synchronous)
