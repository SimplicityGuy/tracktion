...
- [ ] **Task 1: Extend Tracklist Models for Manual Creation** (AC: 4)
  - [ ] Update `services/tracklist_service/src/models/tracklist.py` with draft fields
  - [ ] Add version tracking fields (draft_version, is_draft, parent_tracklist_id)
...
- [ ] **Task 2: Create Draft Management Service** (AC: 4)
  - [ ] Create `services/tracklist_service/src/services/draft_service.py`
  - [ ] Implement draft creation with version tracking
  - [ ] Implement draft saving with auto-versioning
  - [ ] Implement draft retrieval and listing
  - [ ] Implement publish mechanism (draft to final)
  - [ ] Add Redis caching for draft states
  - [ ] Write comprehensive unit tests

- [ ] **Task 3: Implement Manual Track Entry API** (AC: 1)
  - [ ] Create `services/tracklist_service/src/api/manual_endpoints.py`
  - [ ] Implement `POST /api/v1/tracklists/manual` endpoint
  - [ ] Implement individual track CRUD operations
  - [ ] Add validation for track positions (no gaps, no duplicates)
  - [ ] Ensure proper ordering of tracks by position
