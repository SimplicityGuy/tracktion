...
class TestMatchingService:
    ...
    def sample_scraped_tracklist(self):
        ...
        metadata = TracklistMetadata(duration_minutes=60, play_count=1000)
    ...
    def test_match_duration_no_metadata(self, matching_service):
        ...
        tracklist = ScrapedTracklist(url="https://1001tracklists.com/test", dj_name="Test DJ", tracks=[])
    ...
    def test_match_tracklist_to_audio_complete(self, matching_service, sample_scraped_tracklist):
        ...
        confidence, details = matching_service.match_tracklist_to_audio(sample_scraped_tracklist, audio_metadata)
    ...
    def test_match_tracklist_to_audio_partial(self, matching_service, sample_scraped_tracklist):
