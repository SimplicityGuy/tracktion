...
from services.tracklist_service.src.exceptions import (
    ImportError, ScrapingError, ValidationError, MatchingError,
    TimingError, CueGenerationError, DatabaseError, AudioFileError,
    RateLimitError, TimeoutError, ServiceUnavailableError
)
from services.tracklist_service.src.retry.retry_manager import (
    RetryManager, RetryPolicy, FailureType
)
...
class TestRetryManager:
    ...
    def test_retry_policy_failure_specific_overrides(self):
        ...
        policy = RetryPolicy(
            base_delay=1.0,
            failure_policies={
                FailureType.RATE_LIMIT: {"base_delay": 60.0},
                FailureType.NETWORK: {"base_delay": 5.0}
            },
            jitter=False
        )
    ...
    def test_domain_specific_policies(self, retry_manager):
        ...
        custom_policy = RetryPolicy(
            ...
            base_delay=2.0,
            failure_policies={
                FailureType.RATE_LIMIT: {"base_delay": 120.0}
            }
        )
