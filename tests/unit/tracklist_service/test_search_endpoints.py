...
class TestSearchEndpoints:
    ...
    def test_search_1001tracklists_success(self, mock_cache, mock_perform_search, client, mock_search_results):
    ...
    @patch("services.tracklist_service.src.api.search_api._perform_search")
    @patch("services.tracklist_service.src.api.search_api.cache")
    def test_search_with_artist_filter(self, mock_cache, mock_perform_search, client, mock_search_results):
    ...
    @patch("services.tracklist_service.src.api.search_api._perform_search")
    @patch("services.tracklist_service.src.api.search_api.cache")
    def test_search_with_pagination(self, mock_cache, mock_perform_search, client, mock_search_results):
    ...
    def test_search_cached_results(self, mock_cache, client):
        ...
        response = client.get("/api/v1/tracklists/search/1001tracklists", params={"query": "test"})
    ...
    @patch("services.tracklist_service.src.api.search_api._perform_search")
    @patch("services.tracklist_service.src.api.search_api.cache")
    def test_search_with_date_filters(self, mock_cache, mock_perform_search, client, mock_search_results):
    ...
    @patch("services.tracklist_service.src.api.search_api._perform_search")
    @patch("services.tracklist_service.src.api.search_api.cache")
    def test_search_force_refresh(self, mock_cache, mock_perform_search, client, mock_search_results):
    ...
    @patch("services.tracklist_service.src.api.search_api.cache")
    def test_search_health_check_healthy(self, mock_cache, mock_import_service_class, client):
    ...
    @patch("services.tracklist_service.src.api.search_api.ImportService")
    @patch("services.tracklist_service.src.api.search_api.cache")
    def test_search_health_check_degraded(self, mock_cache, mock_import_service_class, client):
