...
class TestImportResultMessage:
    ...
    def test_success_result_message(self):
        ...
        result_message = ImportResultMessage(
            correlation_id=correlation_id, success=True, tracklist_id=tracklist_id, processing_time_ms=5000
        )
    ...
    def test_failure_result_message(self):
        ...
        result_message = ImportResultMessage(
            correlation_id=correlation_id, success=False, error="Import failed: Invalid URL", processing_time_ms=1000
        )
    ...
    def test_result_message_dict_conversion(self):
        ...
        result_message = ImportResultMessage(
            correlation_id=correlation_id, success=True, tracklist_id=str(uuid4()), processing_time_ms=3000
        )
...
class TestImportMessageHandler:
    ...
    async def test_publish_import_result(self, mock_connect, message_handler):
        ...
        correlation_id = str(uuid4())
        result_message = ImportResultMessage(
            correlation_id=correlation_id, success=True, tracklist_id=str(uuid4()), processing_time_ms=5000
        )
...
class TestImportWorker:
    ...
    async def test_process_import_job_success(self, import_worker):
        ...
        with (
            patch.object(import_worker.import_service, "import_tracklist") as mock_import,
