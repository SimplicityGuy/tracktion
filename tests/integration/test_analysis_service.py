...
class TestAnalysisServiceIntegration:
    ...
    @patch('main.StorageHandler')
    @patch('main.MetadataExtractor')
    def test_process_message_success(self, mock_extractor_class, mock_storage_class, 
                                    analysis_service, mock_rabbitmq_message):
    ...
    @patch('main.StorageHandler')
    @patch('main.MetadataExtractor')
    def test_process_message_invalid_file(self, mock_extractor_class, mock_storage_class,
                                         analysis_service, mock_rabbitmq_message):
    ...
    @patch('main.StorageHandler')
    @patch('main.MetadataExtractor')
    def test_process_message_extraction_error(self, mock_extractor_class, mock_storage_class,
                                             analysis_service, mock_rabbitmq_message):
    ...
    @patch('main.StorageHandler')
    @patch('main.MetadataExtractor')
    def test_process_message_storage_error(self, mock_extractor_class, mock_storage_class,
                                          analysis_service, mock_rabbitmq_message):
    ...
    @patch('main.MetadataExtractor')
    @patch('main.MessageConsumer')
    def test_service_shutdown(self, mock_consumer_class, mock_extractor_class, 
                             mock_storage_class, analysis_service):
    ...
    @patch('main.MetadataExtractor')
    @patch('main.MessageConsumer')
    def test_health_check(self, mock_consumer_class, mock_extractor_class, 
                         mock_storage_class, analysis_service):
...
class TestStorageHandlerIntegration:
    ...
    def test_storage_initialization(self, mock_get_session, mock_recording_repo,
                                   mock_metadata_repo, mock_neo4j_repo):
    ...
    @patch('storage_handler.RecordingRepository')
    @patch('storage_handler.get_db_session')
    def test_store_metadata(self, mock_get_session, mock_recording_repo_class,
                           mock_metadata_repo_class, mock_neo4j_repo_class):
