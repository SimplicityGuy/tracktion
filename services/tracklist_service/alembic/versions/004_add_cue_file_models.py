...
def upgrade() -> None:
    ...
    op.create_check_constraint(
        "ck_cue_files_format", "cue_files", "format IN ('standard', 'cdj', 'traktor', 'serato', 'rekordbox', 'kodi')"
    )
    ...
    op.create_check_constraint(
        "ck_cue_generation_jobs_progress", "cue_generation_jobs", "progress >= 0 AND progress <= 100"
    )
