...
class SynchronizationService:
    ...
    async def schedule_sync(
        ...
        try:
            ...
            if frequency != SyncFrequency.MANUAL:
                task = asyncio.create_task(self._scheduled_sync_loop(tracklist_id, frequency, source))
    ...
    async def get_sync_status(
        ...
        try:
            ...
            query = (
                select(SyncEvent)
                .where(SyncEvent.tracklist_id == tracklist_id)
    ...
    async def update_sync_configuration(
        ...
        try:
            ...
            if "sync_frequency" in config_updates:
                ...
                source = SyncSource(config.sync_sources[0] if config.sync_sources else "all")
