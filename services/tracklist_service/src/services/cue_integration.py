...
class CueIntegrationService:
    ...
    def convert_tracklist_to_cue(
        self, tracklist: Tracklist, audio_file_path: str, cue_format: str = "standard"
    ) -> Optional[CueDisc]:
        """
    ...
    def generate_cue_file(self, tracklist: Tracklist, audio_file_path: str, cue_format: str = "standard") -> CueResult:
        """
        ...
        try:
            ...
            cue_disc = self.convert_tracklist_to_cue(tracklist, audio_file_path, cue_format)
            ...
            return CueResult(success=True, cue_file_path=str(cue_file_path), cue_file_id=cue_file_id)

        except Exception as e:
            logger.error(f"Failed to generate CUE file: {e}")
            return CueResult(success=False, error=str(e))

    def store_cue_file_reference(self, tracklist_id: UUID, cue_file_path: str) -> bool:
        """
