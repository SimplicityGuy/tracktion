...
class MatchingService:
    ...
    def match_tracklist_to_audio(
        ...
        if 'duration_seconds' in audio_metadata:
            duration_score = self._match_duration(
                scraped_tracklist,
        ...
        if 'album' in audio_metadata and scraped_tracklist.event_name:
            event_score = self._fuzzy_match(
                scraped_tracklist.event_name,
    ...
    def match_tracklist_with_audio_file(
        self,
        tracklist: 'Tracklist',
        audio_file_id: UUID
    ) -> MatchingResult:
