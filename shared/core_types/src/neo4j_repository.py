...
class Neo4jRepository:
    ...
    def create_recording_node(self, recording_id: UUID, file_name: str,
    ...
    def add_metadata_relationship(self, recording_id: UUID, key: str, 
                                 value: str) -> None:
    ...
    def add_tracklist_with_tracks(self, recording_id: UUID, source: str,
    ...
    def create_recording(self, recording_id: UUID, file_path: str, 
                        file_hash: str, properties: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """Create a Recording node in Neo4j.
    ...
    def create_metadata(self, key: str, value: str, 
                       properties: Optional[Dict[str, Any]] = None) -> UUID:
    ...
    def create_has_metadata_relationship(self, recording_id: UUID, metadata_id: UUID,
    ...
    def create_relationship(self, from_id: UUID, to_id: UUID, 
